...
- [ ] `1-entreprise/identite.md` complete et valide
- [ ] `1-entreprise/mentions-legales.md` revu par responsable metier
- [ ] `2-catalogue/services.json` relu (pas de prix incoherents)
- [ ] `2-catalogue/regles-tarification.md` valide (remises/supplements)

## 2) Qualite technique

- [ ] Tests passent en local (`pytest -q`)
- [ ] Validation des schemas OK (`python _technique/valider_schemas.py`)
